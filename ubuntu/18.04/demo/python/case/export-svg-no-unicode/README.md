...
* export-svg-no-unicode/[svg-export.py](https://github.com/samwhelp/note-about-fontforge/tree/gh-pages/ubuntu/18.04/demo/native/case/export-svg-no-unicode/svg-export.py)
* export-svg-no-unicode/[svg-import.py](https://github.com/samwhelp/note-about-fontforge/tree/gh-pages/ubuntu/18.04/demo/native/case/export-svg-no-unicode/svg-import.py)
